...
The layout usage of `muhindo-admin` can be found in the `index()` method of the home page's layout file [HomeController.php](https://github.com/z-song/muhindo-admin/blob/master/src/Console/stubs/HomeController.stub).
...
`muhindo-admin` use grid system of bootstrap,The length of each line is 12, the following is a few simple examples:

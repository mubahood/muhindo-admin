...
namespace Muhindo\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Muhindo\Admin\Grid grid($model, \Closure $callable)
 * @method static \Muhindo\Admin\Form form($model, \Closure $callable)
 * @method static \Muhindo\Admin\Show show($model, $callable = null)
 * @method static \Muhindo\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Muhindo\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Muhindo\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Muhindo\Admin\Admin::class;
    }
}

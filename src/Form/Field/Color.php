...
class Color extends Text
{
    protected static $css = [
        '/vendor/muhindo-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/muhindo-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];

...
class MultipleFile extends Field
{
    ...
    protected static $css = [
        '/vendor/muhindo-admin/bootstrap-fileinput/css/fileinput.min.css?v=4.5.2',
    ];
     ...
     */
    protected static $js = [
        '/vendor/muhindo-admin/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js',
        '/vendor/muhindo-admin/bootstrap-fileinput/js/fileinput.min.js?v=4.5.2',
        '/vendor/muhindo-admin/bootstrap-fileinput/js/plugins/sortable.min.js?v=4.5.2',
    ];

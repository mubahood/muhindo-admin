...
class SwitchField extends Field
{
    protected static $css = [
        '/vendor/muhindo-admin/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css',
    ];

    protected static $js = [
        '/vendor/muhindo-admin/bootstrap-switch/dist/js/bootstrap-switch.min.js',
    ];
